...
public class PlanningTool  implements Function<String, ToolExecuteResult> {
    ...
    public static DashScopeApi.FunctionTool getToolDefinition() {
        DashScopeApi.FunctionTool.Function function = new DashScopeApi.FunctionTool.Function(description, name, PARAMETERS);
        DashScopeApi.FunctionTool functionTool = new DashScopeApi.FunctionTool(function);
        return functionTool;
    }

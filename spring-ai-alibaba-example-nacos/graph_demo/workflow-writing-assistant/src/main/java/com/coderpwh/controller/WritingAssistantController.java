...
public class WritingAssistantController {
    ...
    @Autowired
    public WritingAssistantController(@Qualifier("writingAssistantStateGraph") StateGraph writingAssistantStateGraph) throws GraphStateException {
        this.compiledGraph = writingAssistantStateGraph.compile();
    }

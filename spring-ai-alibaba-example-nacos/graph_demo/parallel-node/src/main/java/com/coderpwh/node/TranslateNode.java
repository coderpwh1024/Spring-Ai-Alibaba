...
public class TranslateNode implements NodeAction {
    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        String translateStatus = state.value("translateStatus", "");
        logger.info("Current translateStatus: {}", translateStatus);
        ...
        return Map.of("translate_content",generator, "translate_status", "processing");
    }

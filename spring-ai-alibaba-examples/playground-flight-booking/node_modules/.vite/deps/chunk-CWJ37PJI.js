...
var _a;
window.Vaadin ?? (window.Vaadin = {}), (_a = window.Vaadin).registrations ?? (_a.registrations = []), window.Vaadin.registrations.push({ is: "@vaadin/react-components", version: "24.4.4" });
function s(e) {
  const { elementClass: t } = e;
  return createComponent("_properties" in t ? { ...e, elementClass: { name: t.name, prototype: { ...t._properties, hidden: Boolean } } } : e);
}
...
@lit/react/development/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-CWJ37PJI.js.map
